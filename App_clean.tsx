...
export default function App() {
  ...
  // Move startHeartbeatAnimation before useEffect to fix the error
    ...
    const sampleInsights: AIInsight[] = [
      {
        ...
        description: 'Buddy is in excellent health! His recent activity levels and eating patterns show he\'s thriving.',
        priority: 'low',
        timestamp: new Date(),
        actionable: true,
      ...
      },
      {
        ...
        description: 'Consider adding 10 more minutes to your daily walks to maintain optimal fitness.',
        priority: 'medium',
        timestamp: new Date(),
        actionable: true,
  ...
  const addXP = (amount: number) => {
    setXp(prev => {
      ...
      if (newXP >= level * 1000) {
        ...
        setShowAchievement(`Level Up! You're now level ${level + 1}!`);
  ...
  const handlePremiumFeatures = () => {
    ...
    Alert.alert(
      ...
      [
        { text: 'Upgrade Now', onPress: () => setShowPaymentScreen(true) },
